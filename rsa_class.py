...
class rsa_class():
    ...
    def encrypt(self, string, pub):
        ...
        crypt = str(base64.b64encode(crypt), encoding='utf-8') #配合base64，把rsa加密后的字节串转成base64字节串，再转成字符串(rsa加密后的字节串不能直接转成字符串)
...
if __name__ == '__main__':
    ...
    result = rsa_obj.decrypt(tmp,pri)
    print(result)
